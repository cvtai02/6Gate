...
type JobDetailDto = JobDto & {
  account?: { displayName: string | null; username: string | null } | null;
...
export default async function JobDetailPage({
  ...
  let detail: JobDetailDto | null = null;
  try {
    detail = await createServerApiClient().get<JobDetailDto>(`/post-jobs/${id}`);
  } catch {
    notFound();
  }
